        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <StatCard icon={GraduationCap} label="إجمالي الطلاب" value={stats.totalStudents} color="text-primary" />
              <StatCard icon={Users} label="إجمالي الأطباء" value={stats.totalDoctors} color="text-accent" />
              <StatCard icon={BookOpen} label="إجمالي المقررات" value={stats.totalCourses} color="text-warning" />
              <StatCard icon={Calendar} label="إجمالي الجلسات" value={stats.totalSessions} color="text-success" />
            </div>

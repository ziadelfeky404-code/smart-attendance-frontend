...
export default function StudentDashboard() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (historyRes.status === 'fulfilled' && historyRes.value.success && historyRes.value.data) {
        setRecords(historyRes.value.data.records);
        setTotal(historyRes.value.data.total);
      }
  ...
  return (
    <div className="min-h-screen bg-dark" data-testid="student-dashboard">
      <Navbar />
      <main className="lg:pr-64 pt-24 p-6">
        ...
        {loading ? (
          ...
          <>
            <div className="card mb-6" data-testid="student-attendance-summary">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8" data-testid="student-sections-summary">
            ...
            <div className="card" data-testid="student-recent-records">

...
export default function StudentAdvisingPage() {
  ...
  return (
    <div className="min-h-screen bg-dark" data-testid="student-advising-page">
      <Navbar />
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className={`card border ${riskStatus?.overallStatus === 'CRITICAL' ? 'border-red-500/50' : riskStatus?.overallStatus === 'WARNING' ? 'border-yellow-500/50' : 'border-green-500/50'}`} data-testid="student-risk-card">
              ...
              <div className="card" data-testid="student-advisor-card">
                <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex gap-2 mb-6 overflow-x-auto">
              {(['overview', 'sessions', 'plans', 'notifications'] as const).map(tab => (
                <button
                  ...
                  data-testid={`student-advising-tab-${tab}`}
            ...
            {activeTab === 'notifications' && (
              <div className="card" data-testid="student-notifications-panel">
                <h2 className="text-xl font-bold mb-4 flex items-center gap-2">

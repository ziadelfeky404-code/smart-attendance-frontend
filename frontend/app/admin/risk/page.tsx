...
export default function AdminRiskPage() {
  ...
  return (
    <div className="min-h-screen bg-dark" data-testid="admin-risk-page">
      <Navbar />
      <main className="lg:pr-64 pt-24 p-6">
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8" data-testid="admin-risk-stats">
              <div className="card border-red-500/30" data-testid="admin-risk-critical-card">
              ...
              <div className="card border-yellow-500/30" data-testid="admin-risk-warning-card">
                <div className="flex items-center gap-3">
              ...
              <div className="card border-green-500/30" data-testid="admin-risk-good-card">
                <div className="flex items-center gap-3">
              ...
              <div className="card" data-testid="admin-risk-open-cases-card">
                <div className="flex items-center gap-3">
              ...
              <div className="card" data-testid="admin-risk-attendance-card">
                <div className="flex items-center gap-3">
            ...
            <div className="card">
              ...
              {filteredStudents.length > 0 ? (
                <div className="overflow-x-auto" data-testid="admin-risk-students-table">

...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-dark flex items-center justify-center p-4" data-testid="login-page">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="card">
          {error && (
            <div className="flex items-center gap-3 bg-danger/10 border border-danger/20 rounded-xl p-4 mb-6" data-testid="login-error">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" data-testid="login-form">
            ...
            <button type="submit" disabled={loading} className="btn-primary w-full text-lg py-4" data-testid="login-submit">
              {loading ? (

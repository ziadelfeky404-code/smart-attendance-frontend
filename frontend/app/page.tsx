...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-dark" data-testid="home-page">
      <header className="relative overflow-hidden">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 lg:px-12 h-20">
          ...
          {user ? (
            ...
            <Link href="/login" className="btn-primary text-sm" data-testid="home-login-link">
              تسجيل الدخول
            </Link>
          )}
        </nav>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              {user ? (
                ...
                <>
                  <Link href="/login" className="btn-primary text-lg px-8 py-4" data-testid="home-hero-login-link">
                    تسجيل الدخول
                  </Link>
